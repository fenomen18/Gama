...
This mechanism has been integrated into Bitcore-Node-Gama which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/gamacoin/insight-api-gama#web-socket-api](https://github.com/gamacoin/insight-api-gama#web-socket-api)
* API: [https://github.com/gamacoin/insight-api-gama#instantsend-transactions](https://github.com/gamacoin/insight-api-gama#instantsend-transactions)
...
By default, the Gama Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Gama Core daemon:
