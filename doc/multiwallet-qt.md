...
Only requiring some minor changes is gama.cpp.
...
Changes to gama.cpp
----------------------
gama.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
