...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "GamaNetwork") type = GamaNetwork;
    if(strType == "GamaNetworkVariable") type = GamaNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == GamaNetwork) s = "GamaNetwork";
    if(type == GamaNetworkVariable) s = "GamaNetworkVariable";
