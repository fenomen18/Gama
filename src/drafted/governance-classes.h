 ...
 *
 *   // network
 *   CGamaNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.gamacoin.tech/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CGamaNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: GamaNetwork
// //   -- signature requirements : Key1(User)
// class CGamaNetworkVariable : public CGovernanceObject
// {
// private:
