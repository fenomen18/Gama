    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("GAMA-light"), QVariant("light"));
    //ui->theme->addItem(QString("GAMA-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("GAMA-dark"), QVariant("drkblue"));
    //ui->theme->addItem(QString("GAMA-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("GAMA-traditional"), QVariant("trad"));
