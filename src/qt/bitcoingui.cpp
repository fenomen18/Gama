    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Gama Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Gama address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and gama: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Gama Core"), this);
    aboutAction->setStatusTip(tr("Show information about Gama Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Gama Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Gama addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Gama addresses"));
    ...
    openAction->setStatusTip(tr("Open a gama: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Gama Core help message to get a list with possible Gama Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Gama Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Gama network", "", count));
    } else {
...
{
    QString strTitle = tr("Gama Core"); // default title
