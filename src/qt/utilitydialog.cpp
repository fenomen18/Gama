    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Gama Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Gama Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  gama-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Gama in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 GAMA, 0.1 GAMA, 1 GAMA and 10 GAMA -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://gamacoin.tech/wiki/display/DOC/PrivateSend\">https://gamacoin.tech/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Gama Core is shutting down...") + "<br /><br />" +
